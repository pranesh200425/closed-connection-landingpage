...
function Header() {
  return (
    <header className='flex w-[80%] rounded-3xl m-4 min-h-[5rem]  p-5' >
        <p className='flex flex-col w-full justify-center' >
            <span className='text-center text-5xl font-bold tracking-widest ' >Welcome to <span className='inline- font-bold
      ...
      bg-clip-text text-transparent' id='text-gradient' > Closed-Connections</span></span>
            <span className='flex justify-center mt-8 underline text-center text-3xl leading-16 ' >
